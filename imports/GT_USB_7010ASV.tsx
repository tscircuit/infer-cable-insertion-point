    ...
    <chip
      ...
      footprint={
        <footprint>
          ...
          <silkscreenpath
            route={[
              { x: -4.500016399999936, y: -1.5764890499999638 },
              { x: -4.500016399999936, y: 0.23646135000001323 },
            ]}
          />
          <silkscreenpath
            route={[
              { x: 4.499991000000136, y: -1.5764890499999638 },
              { x: 4.499991000000136, y: 0.23646135000001323 },
            ]}
          />
          <silkscreenpath
            route={[
              { x: -4.500016399999936, y: -5.3150388500000645 },
              { x: -4.500016399999936, y: -3.7936042500001577 },
            ]}
          />
          <silkscreenpath
            route={[
              { x: 4.499991000000136, y: -5.3150388500000645 },
              { x: 4.499991000000136, y: -3.7936042500001577 },
            ]}
          />
          <silkscreenpath
            route={[
      ...
      cadModel={{
        objUrl:
          "https://modelcdn.tscircuit.com/easyeda_models/download?uuid=be50d0558ed84d368584cedb268b51a8&pn=C2988369",
        rotationOffset: { x: 0, y: 0, z: 0 },
        positionOffset: {
          x: 0.000025400000026820635,
          y: -1.3349858499999527,
          z: -1.9350466499999583,
        },
      }}
      {...props}
    />
