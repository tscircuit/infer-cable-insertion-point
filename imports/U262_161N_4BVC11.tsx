    ...
    <chip
      ...
      footprint={
        <footprint>
          ...
          <silkscreenpath
            route={[
              { x: 4.459986000000072, y: -1.6420337500001096 },
              { x: 4.459986000000072, y: 0.09959344999992936 },
            ]}
          />
          <silkscreenpath
            route={[
              { x: -4.4699935999999525, y: -3.8787069499999234 },
              { x: -4.4699935999999525, y: -5.39998915000001 },
              { x: 4.459986000000072, y: -5.39998915000001 },
              { x: 4.459986000000072, y: -3.880484949999982 },
            ]}
          />
          <silkscreenpath
            route={[
              { x: -4.4699935999999525, y: 0.10137144999998782 },
              { x: -4.4699935999999525, y: -1.6438117500000544 },
            ]}
          />
        </footprint>
      }
      cadModel={{
        objUrl:
          "https://modelcdn.tscircuit.com/easyeda_models/download?uuid=c50ce21ae3b941ce8eeb9bccc6cdef41&pn=C319148",
        rotationOffset: { x: 0, y: 0, z: 180 },
        positionOffset: {
          x: 0,
          y: -1.4277847500001144,
          z: -2.0112593500000004,
        },
      }}
      {...props}
    />
