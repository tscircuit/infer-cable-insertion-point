...
export const HC_TYPE_C_16P_01A = (props: ChipProps<typeof pinLabels>) => {
  return (
    <chip
      ...
      footprint={
        <footprint>
          ...
          <platedhole
            portHints={["pin3"]}
            pcbX="4.320031999999969mm"
            pcbY="-2.7099513500000967mm"
            holeWidth="0.5999987999999999mm"
            holeHeight="1.1999975999999997mm"
            outerWidth="0.9999979999999999mm"
          ...
          <silkscreenpath
            route={[
              { x: 4.500016399999936, y: -1.701215750000074 },
              { x: 4.500016399999936, y: 0.211658249999914 },
            ]}
          />
          <silkscreenpath
            route={[
              { x: 4.500016399999936, y: -5.309768350000127 },
              { x: 4.500016399999936, y: -3.718331350000085 },
            ]}
          />
          <silkscreenpath
            route={[
              { x: -4.499965599999996, y: -1.701215750000074 },
              { x: -4.499965599999996, y: 0.2117344499997671 },
            ]}
          />
          <silkscreenpath
            route={[
              { x: -4.499965599999996, y: -5.309768350000127 },
              { x: -4.499965599999996, y: -3.718331350000085 },
            ]}
          />
          <silkscreenpath
            route={[
      ...
      cadModel={{
        objUrl:
          "https://modelcdn.tscircuit.com/easyeda_models/download?uuid=69a4d34b57454869b49343b4e6632b8d&pn=C2894897",
        rotationOffset: { x: 0, y: 0, z: 0 },
        positionOffset: {
          x: 0,
          y: -1.4560295500000393,
          z: -1.9599513499999943,
        },
      }}
      {...props}
    />
