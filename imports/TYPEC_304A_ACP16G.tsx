...
export const TYPEC_304A_ACP16G = (props: ChipProps<typeof pinLabels>) => {
  return (
    <chip
      ...
      footprint={
        <footprint>
          <hole
            ...
            pcbY="1.045470400000113mm"
            diameter="0.6499860000000001mm"
          />
          <hole
            pcbX="2.8900119999998424mm"
            pcbY="1.045470400000113mm"
            diameter="0.6499860000000001mm"
          />
          <platedhole
          ...
          <smtpad
            portHints={["pin29"]}
            pcbX="3.350005999999894mm"
            pcbY="2.1099843999999166mm"
          ...
          <silkscreenpath
            route={[
              { x: 4.470019000000093, y: -1.5194724000000406 },
              { x: 4.470019000000093, y: 0.2794825999999375 },
            ]}
          />
          <silkscreenpath
            route={[
              { x: 4.470019000000093, y: -5.234577999999942 },
              { x: 4.470019000000093, y: -3.750506800000039 },
            ]}
          />
          <silkscreenpath
            route={[
              { x: -4.469968199999926, y: -1.5194470000001274 },
              { x: -4.469968199999926, y: 0.2794572000000244 },
            ]}
          />
          <silkscreenpath
            route={[
              { x: -4.469968199999926, y: -5.234577999999942 },
              { x: -4.469968199999926, y: -3.750532200000066 },
            ]}
          />
          <silkscreenpath
            route={[
      ...
      cadModel={{
        objUrl:
          "https://modelcdn.tscircuit.com/easyeda_models/download?uuid=73862176508e4c58a6f64af27e8c7915&pn=C2909608",
        rotationOffset: { x: 0, y: 0, z: 0 },
        positionOffset: {
          x: 1.1368683772161603e-13,
          y: -1.4334680000000617,
          z: -1.8849895999999375,
        },
      }}
      {...props}
    />
