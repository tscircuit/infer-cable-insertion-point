    ...
    <chip
      ...
      footprint={
        <footprint>
          ...
          <smtpad
            portHints={["pin19"]}
            pcbX="2.2499065999999175mm"
            pcbY="2.1150453500000594mm"
            width="0.29999939999999997mm"
            height="1.2999973999999999mm"
            shape="rect"
          />
          ...
          <silkscreenpath
            route={[
              { x: 4.57197460000009, y: -1.6232250499999736 },
              { x: 4.57197460000009, y: 0.27306275000000824 },
            ]}
          />
          <silkscreenpath
            route={[
              { x: -4.572025399999916, y: -3.8070154499999944 },
              { x: -4.572025399999916, y: -5.380088249999972 },
              { x: 4.57197460000009, y: -5.380088249999972 },
              { x: 4.57197460000009, y: -3.8070154499999944 },
            ]}
          />
          <silkscreenpath
            route={[
              { x: -4.572025399999916, y: 0.27306275000000824 },
              { x: -4.572025399999916, y: -1.6232250499999736 },
            ]}
          />
        </footprint>
      }
      cadModel={{
        objUrl:
          "https://modelcdn.tscircuit.com/easyeda_models/download?uuid=954b2a5828604707b62aef0fe6e7695f&pn=C709357",
