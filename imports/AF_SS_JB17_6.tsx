    ...
    <chip
      ...
      footprint={
        <footprint>
          ...
          <silkscreenpath
            route={[
              { x: 7.3659999999999854, y: -4.376445399999966 },
              { x: 7.3659999999999854, y: -12.826999999999884 },
              { x: -7.3659999999999854, y: -12.826999999999884 },
            ]}
          />
          <silkscreenpath
            route={[
              { x: 7.3659999999999854, y: 1.3235686000000442 },
              { x: 7.3659999999999854, y: -1.3235686000000442 },
            ]}
          />
          <silkscreenpath
            route={[
              { x: -7.3659999999999854, y: 4.376445399999966 },
              { x: -7.3659999999999854, y: 4.826000000000022 },
              { x: 7.3659999999999854, y: 4.826000000000022 },
              { x: 7.3659999999999854, y: 4.376445399999966 },
            ]}
          />
      ...
      cadModel={{
        objUrl:
          "https://modelcdn.tscircuit.com/easyeda_models/download?uuid=49889e8479314b9894f916135c24ddd0&pn=C456021",
