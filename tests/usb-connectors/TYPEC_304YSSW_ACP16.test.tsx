...
import { TYPEC_304YSSW_ACP16 as ImportedUsb } from "../../imports/TYPEC_304YSSW_ACP16"

test("TYPEC_304YSSW_ACP16 cable insertion center", async () => {
