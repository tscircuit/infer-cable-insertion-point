...
import { TYPE_C_6P_WTL10_0_108 as ImportedUsb } from "../../imports/TYPE_C_6P_WTL10_0_108"

test("TYPE_C_6P_WTL10_0_108 cable insertion center", async () => {
  ...
  const { circuitJsonWithNote } = addCableInsertNoteRect(circuitJson, {
    idPrefix: "TYPE_C_6P_WTL10_0_108",
    noteWidth: 1.2,
    noteHeight: 1.2,
  })
