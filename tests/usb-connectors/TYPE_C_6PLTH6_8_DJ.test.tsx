...
import { TYPE_C_6PLTH6_8_DJ as ImportedUsb } from "../../imports/TYPE_C_6PLTH6_8_DJ"

test("TYPE_C_6PLTH6_8_DJ cable insertion center", async () => {
